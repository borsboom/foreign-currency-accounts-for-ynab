...
4. Download the appropriate binary executable for your platform:
   ...
   |--------------------|---------------|
   | Linux (x86 64-bit) | [fca4ynab-0.1.3-x86_64-linux](https://github.com/borsboom/foreign-currency-accounts-for-ynab/releases/download/release%2F0.1.3/fca4ynab-0.1.3-x86_64-linux) |
   | macOS              | [fca4ynab-0.1.3-x86_64-darwin](https://github.com/borsboom/foreign-currency-accounts-for-ynab/releases/download/release%2F0.1.3/fca4ynab-0.1.3-x86_64-darwin) |
   | Windows (64-bit)   | [fca4ynab-0.1.3-x86_64-mingw64.exe](https://github.com/borsboom/foreign-currency-accounts-for-ynab/releases/download/release%2F0.1.3/fca4ynab-0.1.3-x86_64-mingw64.exe) |
...
5. On Linux and macOS, give the downloaded file execute permissions:
   ...
   ```
   $ chmod a+x /path/to/fca4ynab-0.1.3-*
   ```
...
2. Download the source code and unpack: [.zip](https://github.com/borsboom/foreign-currency-accounts-for-ynab/archive/release/0.1.3.zip), [.tar.gz](https://github.com/borsboom/foreign-currency-accounts-for-ynab/archive/release/0.1.3.tar.gz), or clone the [Git repository](https://github.com/borsboom/foreign-currency-accounts-for-ynab/tree/release/0.1.3).
